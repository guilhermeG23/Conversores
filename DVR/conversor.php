...
if (isset($_FILES['arquivo'])) {
	...
	$arquivo_input = '/var/www/html/DVR/trabalho/'.$arquivo_extensao_dav;
	move_uploaded_file($_FILES['arquivo']['tmp_name'], $arquivo_input);
	shell_exec("ffmpeg -y -i $arquivo_input -vcodec libx264 -crf 24 -filter:v 'setpts=1*PTS' /var/www/html/DVR/arquivos/$arquivo_extensao_mp4");
